...
else{ $CacheParameter = "-Sh"}

if ($writezero -eq $true){
$WritezeroParameter = "-Z"
}
else{ $WritezeroParameter = $Null}
".\diskspd.exe $TestFileSizeParameter $DurationParameter $AccessTypeParameter $WriteParameter $ThreadParameter $OutstandingIOParameter $BlockSizeParameter $CacheParameter $WritezeroParameter -L $PathParameter\testfile.dat" | out-file C:\diskspeed.txt -Append
$result = .\diskspd.exe $TestFileSizeParameter $DurationParameter $AccessTypeParameter $WriteParameter $ThreadParameter $OutstandingIOParameter $BlockSizeParameter $CacheParameter $WritezeroParameter -L $PathParameter\testfile.dat
...
#Cache Enabled
If ($EnableCacheCheckbox.Checked -eq $true){
$cache = $true
}
else {$cache = $false
}
...
#WriteZero Enabled
If ($EnablewritezeroCheckbox.Checked -eq $true){
$writezero = $false
}
else {$writezero = $true
}
...
$outcome = Test-StoragePerformance -Name $NameTest -TestFileSize $TestFileSizeGB -WritePercentage $WritePercTest -Duration $DurationTest -Blocksize $BlocksizeTest -AccessType $AccessTypeTest -Threads $ThreadsTest -OutstandingIO $OutstandingIOTest -Path $FolderTest -Cache $Cache -writezero $writezero
...
$GroupBoxSettings.size = New-Object System.Drawing.Size(200,130) #the size in px of the group box (length, height)
...
#Enable Cache Label
$EnableCacheLabel = New-Object windows.Forms.Label
$EnableCacheLabel.Location = New-Object System.Drawing.Size(10,84) 
$EnableCacheLabel.AutoSize = $true
$EnableCacheLabel.Text = "Enable Caching"
$groupBoxSettings.Controls.Add($EnableCacheLabel)

#Enable Cache checkbox
$EnableCacheCheckbox = new-Object windows.Forms.checkbox;
$EnableCacheCheckbox.Location = New-Object System.Drawing.Size(150,76) 
$EnableCacheCheckbox.Size = New-Object System.Drawing.Size(20,30)
$EnableCacheCheckbox.Checked = $true
$groupBoxSettings.Controls.Add($EnableCacheCheckbox) 


#Enable WriteZero Label
$WriteZeroLabel = New-Object windows.Forms.Label
$WriteZeroLabel.Location = New-Object System.Drawing.Size(10,110) 
$WriteZeroLabel.AutoSize = $true
$WriteZeroLabel.Text = "Write Zeros"
$groupBoxSettings.Controls.Add($WriteZeroLabel)

#Enable WriteZero checkbox
$EnableWriteZeroCheckbox = new-Object windows.Forms.checkbox;
$EnableWriteZeroCheckbox.Location = New-Object System.Drawing.Size(150,108) 
$EnableWriteZeroCheckbox.Size = New-Object System.Drawing.Size(20,20)
$EnableWriteZeroCheckbox.Checked = $true
$groupBoxSettings.Controls.Add($EnableWriteZeroCheckbox) 
